...
import { initialValue, validationSchema } from "./MenuForm.form";
...
export const MenuForm = (props) => {
  ...
  const formik = useFormik({
    initialValues: initialValue(menu),
  ...
  return (
    <Form onSubmit={formik.handleSubmit}>
      <Form.Group widths="equal">
        <Form.Input name="title" type="text" placeholder="Titulo" onChange={formik.handleChange} value={formik.values.title} error={formik.errors.title} />
