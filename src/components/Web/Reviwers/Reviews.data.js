...
export const reviewsData = [
  ...
  },
  {
    ...
    comment: "Si te gustan los cursos que profundizan en la materia, te lo recomiendo. El profesor explica de forma completa todos los conceptos necesarios para trabajar con grid. Un gran curso.",
  },
  {
    userName: "Marc Perez",
    userType: "UI/UX",
    avatar: image.avatar04,
    comment: "Empecé el curso sin saber nada de React Native y creo que lo finalizo teniendo un nivel de conocimiento como para embarcarme en realizar mi primera aplicación.",
  },
  {
    userName: "Jesus Cruz",
    userType: "Frontend Developer",
    avatar: image.avatar05,
    comment: "Me ha parecido un buen curso, las explicaciones muy claras y lo que enseña me ha sido muy útil para la aplicación que me habían encargado.",
  },
  {
